...
var settings = {
	...
	volume: (utils.isLocalStorageAllowed() ? (window.localStorage.volume > 1 ? (window.localStorage.volume / 100) : window.localStorage.volume ) : 0.9) || 0.9, // TODO: This is terrible
	direction: 'forwards'
};
